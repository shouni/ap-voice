...
// 低並列を実際より良く見せます。**この偏りは 4 への変更と逆向きに効く**ので、
...
// 2.0 〜 3.2 秒です。**短い台本ほど待ちの割合が大きい**という、いちばん目につく
// ところに効いていました。
