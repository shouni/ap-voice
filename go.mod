...
require (
	...
	github.com/shouni/audio v1.4.2
	...
	github.com/shouni/go-voicevox v1.11.2
	github.com/shouni/go-web-reader v1.6.1
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/s3/transfermanager v0.4.4 // indirect
